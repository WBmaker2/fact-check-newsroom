import { ArrowRight, BookOpenText, FileSearch, Scale, ShieldCheck } from 'lucide-react';

export function StartScreen({ onStart, onTeacherGuide }: { onStart: () => void; onTeacherGuide: () => void }) {
  return <section className="start-screen" data-od-id="start-screen">
    <div className="start-copy">
      ...
      <div className="start-actions"><button className="button button-primary button-large" onClick={onStart}>편집 회의 시작<ArrowRight aria-hidden="true" /></button><button className="button button-quiet" onClick={onTeacherGuide}><BookOpenText aria-hidden="true" />교사용 수업 안내</button></div>
    </div>
